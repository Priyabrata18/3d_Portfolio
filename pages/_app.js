...
export default function App({ Component, pageProps }) {
    ...
    const title = "Portfolio | Priyabata Das";
    const description =
        "Hello! I'm Priyabrata Das, a passionate web developer and problem solver. Welcome to my portfolio";
    const avatar =
        "d049680b-f10b-4a43-88ed-829a10c5b3d0.jpg";
