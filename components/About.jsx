...
function About() {
  return (
    ...
    >
      ...
      >
        <div>
          Hello! I&apos;m Priyabrata Das, a passionate web developer, problem
          solver and Frontend develpoer. Currently, I&apos;m the Web development intern at Code Clause PVT LTD, and
          I&apos;m pursuing a B.Tech. degree in Information Technology at
         Odisha University of technology and Research,Bhubaneswar,Odisha India, with an completed
          graduation year of 2024. I&apos;m a Frontend/Full Satck Developer with experience
          ...
          knowledge extends to fundamental Python,Java and HTML&CSS,
        ...
        <div className="w-fit break-words">
          <Link
            href="mailto:priyabratadas2001@gmail.com"
            target="_blank"
            rel="noreferrer"
